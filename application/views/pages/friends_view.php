        ...
        <div class="headline">
            ...
            <?php foreach($friends as $friend):?>
                <div class="col-md-3">
                    ...
                    $fimage = '<img class="img-responsive" src="'.base_url().'assets/uploads/images/friends/'.$friend['img_url'].'" alt="'.$friend['title'].'" title="'.$friend['title'].'" >';
                    echo '<div class="friend"><a href="'.$friend['link'].'">'.$fimage.$friend['title'].'</a></div>';
