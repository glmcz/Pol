        ...
        <div class="blog margin-bottom-40">
            <div class="blog-post-tags">
              <ul class="list-unstyled list-inline blog-info">
                ...
                <?php if(!empty($author)):?>
                <li>
					<i class="fa fa-user fa-lg"></i> <a href="<?php echo base_url('author/id_'.$author['author_id']);?>"><?php echo $author['name'];?></a>
				</li>
                <?php endif;?>
            ...
            <div class="blog-img">
                <?php if(isset($info['video_url']) && $info['video_url'] != ''):?>
                    <div class="responsive-video">
                        ...
                        <img src="<?php echo base_url().'assets/uploads/images/materials/'.$info['img_url'];?>" alt="<?php echo $content['title'];?>" title="<?php echo $content['title'];?>" class="img-responsive" style="display: none;">
                    </div>
                <?php else:?>
                    <?php if($content['text'] != ''):?>
                    <img src="<?php echo base_url().'assets/uploads/images/materials/'.$info['img_url'];?>" alt="<?php echo $content['title'];?>" title="<?php echo $content['title'];?>" class="img-responsive">
                    <?php endif;?>
                <?php endif;?>
            ...
            <div class="blog-audio">
                    ...
                    <link href="<?php echo base_url();?>assets/jplayer/dist/skin/blue.monday/css/jplayer.blue.monday.css" rel="stylesheet" type="text/css" />
                    <script type="text/javascript" src="<?php echo base_url();?>assets/jplayer/dist/jplayer/jquery.jplayer.min.js"></script>
                    <script type="text/javascript" src="<?php echo base_url();?>assets/jplayer/dist/jplayer/jplayer.playlist.js"></script>
                    ...
                    $(document).ready(function(){
                        ...
                        var tracks = <?php echo json_encode($audios); ?>;
                    ...
                    <div id="jp_container_1" class="jp-audio" role="application" aria-label="media player">
                    	<div class="jp-type-playlist">
                    		...
                    		<div class="jp-no-solution">
                    			<?php echo $this->lang->line('material_audio_update');?>
                    		</div>
                    	</div>
                    </div>
            ...
            <style>
                .galleria{ width: 100%; height: 400px; background: #000; margin: 0 0 40px 0; }
            </style>

            <script src="<?php echo base_url().'assets/galleria/galleria-1.4.2.min.js';?>"></script>

            <div class="galleria">
            <?php foreach($photos as $photo):?>

                <img src="<?php echo base_url().'assets/uploads/images/photos/'.$photo['img_url'];?>" alt="<?php echo $photo['title'];?>" title="<?php echo $photo['title'];?>" class="img-responsive"><br />
            ...
            <script>
                ...
                Galleria.run('.galleria', { _toggleInfo: true });
            </script>
                ...
                <?php if($info['comments']):?>
                    ...
                    function comment_loop($comments, $dash = '', $userdata = FALSE)
            		{
                        ...
                        elseif(LANGUAGE == 'ua'):
                            ...
                            $comment_answer = 'Odpověď';
                            $comment_rating = 'Hodnocení';
