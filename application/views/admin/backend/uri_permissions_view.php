...
<h1>Управление URI доступами</h1>
	...
	<?php  				
		...
		echo form_submit('show', 'Показать URI доступы'); 
		
		echo form_label('', 'uri_label');
				
		echo '<hr/>';
				
		echo 'Доступные URI (Один URI в строке) :<br/><br/>';
		...
		echo '<br/>';
		echo form_submit('save', 'Сохранить URI доступ');
