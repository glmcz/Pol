<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../../../uploads/images/tinymce/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../../uploads/images/tinymce/'; // absolute or relative from this script path, required.
        ...
        $mcImageManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,JPG";
